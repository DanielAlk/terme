...
class ZonesControllerTest < ActionController::TestCase
  ...
  test "should create zone" do
    assert_difference('Zone.count') do
      post :create, zone: { ancestry: @zone.ancestry, shipment_cost: @zone.shipment_cost, title: @zone.title }
    end
  ...
  test "should update zone" do
    patch :update, id: @zone, zone: { ancestry: @zone.ancestry, shipment_cost: @zone.shipment_cost, title: @zone.title }
    assert_redirected_to zone_path(assigns(:zone))
  end
