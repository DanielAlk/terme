class UserAddressesController < ApplicationController
  ...
  def new
    @user_address = current_user.user_addresses.new(email: current_user.email, fname: current_user.fname, lname: current_user.lname)
  end
  ...
  private
    ...
    def user_address_params
      params.require(:user_address).permit(:address, :user_id, :email, :fname, :lname, :company, :zip_code, :city, :mobile, :zone_id, :position)
    end
end
